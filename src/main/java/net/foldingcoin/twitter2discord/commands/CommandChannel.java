...
import net.foldingcoin.twitter2discord.*;
...
public class CommandChannel extends CommandModerator {
    ...
    public void processCommand(BotBase bot, IChannel channel, IMessage message, String[] params) {
        ...
        List<Long> orDefault = Configuration.channelsToPostIn.getOrDefault(params[0], new LinkedList<>());
        ...
        Configuration.channelsToPostIn.put(params[0], orDefault);
